...
// Vamos sofisticar um pouco mais nosso script. Além de imprimir o IMC na tela, imprima também em qual categoria da tabela abaixo aquele IMC se enq

const getImc = (peso, altura) => {
  return peso / (Math.pow(altura, 2))
}

console.log(getImc(86, 1.82))
